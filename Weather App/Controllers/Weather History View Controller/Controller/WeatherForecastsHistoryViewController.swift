...
class WeatherHistoryViewController: UIViewController {
    ...
    private var historyСellPresenter = WeatherHistoryCellPresenter()
    ...
    // MARK: -- Configure UI
    func configureWeatherHistoryCell(_ cell: WeatherHistoryCell,
                                     withWeather weather: Weather) {
        
        guard let viewModel = historyСellPresenter.createViewModel(from: weather) else { return }
...
extension WeatherHistoryViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        configureWeatherHistoryCell(cell, withWeather:weather)
